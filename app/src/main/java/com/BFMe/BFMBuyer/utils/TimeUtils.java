...
public class TimeUtils {
    ...
    //字符串转指定格式时间
    public static String StringToDate(String dateStr, String oldFormatStr, String newFormatStr) {
        ...
        SimpleDateFormat s = new SimpleDateFormat(newFormatStr);
    ...
    /**
     *
     * @param overDate 订单未支付结束时间
     * @return 倒计时
     */
    public static long getTime(String overDate) {
        long orderOverTime = string2Milliseconds(overDate);
        long curTimeMills = getCurTimeMills();
        long countdown = orderOverTime - curTimeMills;
