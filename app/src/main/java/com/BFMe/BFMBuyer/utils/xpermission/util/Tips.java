package com.BFMe.BFMBuyer.utils.xpermission.util;
...
public class Tips {
	...
	public Tips setOnSingleListener(final SingleListener singleListener){
		...
		mAlertDialog.setNegativeButton("取消", new OnClickListener() {
		...
		mAlertDialog.setPositiveButton("确定", new OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
