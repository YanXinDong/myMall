...
public class MyDividerGridItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param dividerColor
     */
    public MyDividerGridItemDecoration(Context context, int dividerWidth,int dividerHeight, int dividerColor) {
    ...
    public void getItemOffsets(Rect outRect, int itemPosition,
                               RecyclerView parent) {
        if(parent instanceof XRecyclerView) {//如果是XRecycleView那么itemPosition需要-1
