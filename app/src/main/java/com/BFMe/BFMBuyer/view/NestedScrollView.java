...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent,
    ...
    /**
     * ID of the inactive pointer. This is used to retain consistency during
    ...
    /**
     * Sentinel value for no current inactive pointer.
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (pointerIndex == -1) {
                    Logger.e(  "Invalid pointerId=" + activePointerId
    ...
    private void onSecondaryPointerUp(MotionEvent ev) {
        ...
        if (pointerId == mActivePointerId) {
            // This was our inactive pointer going up. Choose a new
            // inactive pointer and adjust accordingly.
